const En = {
    ...
    language: {
        ...
        export: 'Export',
        exportJson: 'Generate JSON',
        exportOptions: 'Generate Options',
        exportPreviewUrl: 'Generate Preview URL',
        importTip: 'Support importing international configuration files in .ts or .js format, such as public_page.ts. The system will automatically parse key-value pairs from the file and import them into the selected language.',
        targetLanguage: 'Target Language',
        uploadFile: 'Upload File',
        pleaseSelect: 'Please Select',
        importPreview: 'Preview (First 5)',
        entries: 'entries',
