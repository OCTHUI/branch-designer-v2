const ZhCn = {
    ...
    language: {
        ...
        import: '导入',
        importJson: '导入 JSON',
        importOptions: '导入 Options',
        export: '导出',
        exportJson: '生成 JSON',
        exportOptions: '生成 Options',
        exportPreviewUrl: '生成预览链接',
        importTip: '支持导入 .ts 或 .js 格式的国际化配置文件，如 public_page.ts。系统将自动解析文件中的键值对并导入到选定的语言中。',
        targetLanguage: '目标语言',
        uploadFile: '上传文件',
        pleaseSelect: '请选择',
        importPreview: '预览（前 5 条）',
        entries: '个词条',
